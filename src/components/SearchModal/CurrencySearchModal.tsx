import { Currency, Token } from 'garfieldswap-sdk'
    ...
    >
      <Column style={{ width: '100%' }}>
        <PaddedColumn gap="14px">
          <RowBetween>
            <Text fontWeight={500} fontSize={16} color={theme.text3}>
              Select a token
            </Text>
        ...
        <Card>
          <AutoRow justify={'center'}>
            <div>
              <LinkStyledButton style={{ fontWeight: 500, color: theme.text3, fontSize: 16 }} onClick={openTooltip}>
