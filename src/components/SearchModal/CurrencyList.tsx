import { Currency, CurrencyAmount, currencyEquals, ETHER, JSBI, Token } from 'garfieldswap-sdk'
...
export default function CurrencyList({
  ...
  return (
    <FixedSizeList
      ...
      itemSize={56}
      style={{ flex: '1' ,background:'#492710',margin:'0 20px',borderRadius:'6px',color:'#fff'}}
