import { CurrencyAmount, JSBI, Trade } from 'garfieldswap-sdk'
    ...
    <>
      ...
      <AppBody disabled={showWarning}>
        ...
        <Wrapper id="swap-page">
          ...
          <AutoColumn gap={'md'}>
            <CurrencyInputPanel
              label={independentField === Field.OUTPUT && !showWrap ? '至' : '从'}
            ...
            <CurrencyInputPanel
              ...
              label={independentField === Field.INPUT && !showWrap ? '至' : 'To'}
              showMaxButton={false}
