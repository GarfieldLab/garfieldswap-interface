...
import { JSBI, Token, TokenAmount, WETH, Fraction, Percent, CurrencyAmount } from 'garfieldswap-sdk'
    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        ...
        addTransaction(response, {
          summary: `Remove ${token.equals(WETH[chainId]) ? 'WHT' : token.symbol}/HT V1 liquidity`
        })
  ...
  return (
    <AutoColumn gap="20px">
      ...
      <TYPE.darkGray style={{ textAlign: 'center' }}>
        {`Your Uniswap V1 ${
          token.equals(WETH[chainId]) ? 'WHT' : token.symbol
